                ...
                <div class="table-responsive">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            {{-- input form --}}
                            <input type="text" class="form-control mt-4" id="icon" name="icon"
                                value="{{ $service->icon }}" readonly required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="description" name="description"
                                placeholder="Masukan deskripsip layanan" required>{{ $service->description }}</textarea>
                        </div>
                        <div class="form-group">
