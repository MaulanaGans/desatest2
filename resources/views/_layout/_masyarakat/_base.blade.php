...
<head>
    @include('_layout._masyarakat._meta')
    <title>{{ $title }}</title>
    @yield('custom_css')
    <!-- Favicon icon -->
                    ...
                    <div class="navbar-brand">
                        ...
                        <a href="/masyarakat">
                            <b class="logo-icon">
                                ...
                                <!-- Dark Logo icon -->
                                <img src="/dashboard_assets/assets/images/logo-icon.png" alt="homepage"
                                    class="dark-logo" />
                                <!-- Light Logo icon -->
                                <img src="/dashboard_assets/assets/images/logo-icon.png" alt="homepage"
                                    class="light-logo" />
                            ...
                            <span class="logo-text">
                                <!-- dark Logo text -->
                                <img src="/dashboard_assets/assets/images/logo-text.png" alt="homepage"
                                    class="dark-logo" />
                                <!-- Light Logo text -->
                                <img src="/dashboard_assets/assets/images/logo-light-text.png" class="light-logo"
                                    alt="homepage" />
                            </span>
                        </a>
                    </div>
        ...
        <aside class="left-sidebar" data-sidebarbg="skin6">
            <div class="user-profile text-center pt-2">
                ...
                <div class="profile-section">
                    ...
                    <span class="op-7 font-14">Masyarakat</span>
                    <div class="row border-top border-bottom mt-3 no-gutters">
                        <div class="col-6 border-right">
                            <a class="p-3 d-block menubar-height" id="bottom-sidebar" href="/masyarakat/settings"
                                role="button">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link active" href="/masyarakat" aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link" href="/masyarakat/pengaduan/create"
                                aria-expanded="false">
                                <i data-feather="flag" class="feather-icon"></i>
                                <span class="hide-menu">Kirim Usulan</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link" href="/masyarakat/pengaduan" aria-expanded="false">
                                <i data-feather="flag" class="feather-icon"></i>
                                <span class="hide-menu">Usulan Terkirim</span>
                            </a>
                        </li>
                        <li class="nav-small-cap">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link" href="/masyarakat/layanan/surat" aria-expanded="false">
                                <i data-feather="mail" class="feather-icon"></i>
                                <span class="hide-menu">Pembuatan Surat</span>
                            </a>
                        </li>
                    </ul>
                </nav>
